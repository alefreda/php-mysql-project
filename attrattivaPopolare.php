...
<html lang="it" dir="ltr">
  ...
  <body>
    ...
    <div class="input-group">
      <form  action="attrattivaPopolare.php" method="post">
				<div class="input-group">
          ...
          $citta = $_POST['citta'];
				echo "Statistiche relative a: <strong>".$citta."</strong><br>";

				$queryStat1 = ("CALL Stat1()");
				$query = mysqli_query($db, $queryStat1);

        $queryInfoStat1 = ("CALL infoStat1('$citta')");
        $query2 = mysqli_query($db, $queryInfoStat1);

					while($row=mysqli_fetch_assoc($query2)){
            echo '<br>Attrattiva:<strong> '.$row['nome'].'</strong><br>' ;
            echo 'Voto:<strong> '.$row['Voto'].'</strong><br>' ;
					}
				}
					?>
